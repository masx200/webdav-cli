...
const d = [ "all", "canCreate", "canDelete", "canMove", "canRename", "canAppend", "canWrite", "canRead", "canSource", "canGetMimeType", "canGetSize", "canListLocks", "canSetLock", "canRemoveLock", "canGetAvailableLocks", "canGetLock", "canAddChild", "canRemoveChild", "canGetChildren", "canSetProperty", "canGetProperty", "canGetProperties", "canRemoveProperty", "canGetCreationDate", "canGetLastModifiedDate", "canGetWebName", "canGetType" ];
...
class A {
    ...
    #t(e) {
        const s = t(g, "/../certs/self-signed.key.pem"), n = t(g, "/../certs/self-signed.cert.pem"), o = e.path || process.cwd(), r = e.host || "0.0.0.0", a = e.port || 1900, c = Boolean(e.digest);
        ...
        const _ = (e.rights || [ "all" ]).filter((e => d.includes(e))), S = `${u ? "https" : "http"}://${r}:${a}`;
        return {
            ...e,
            host: r,
            path: o,
...
(async function(e) {
    ...
    return l.on("unhandledRejection", (e => {
